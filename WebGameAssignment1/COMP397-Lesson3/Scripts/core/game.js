...
function buildStory() {
    ...
    /* 10 */ storyObjects.push(new objects.Story(["You step into a bend of a hallway, the wall", "destroyed and blocking your advance. Uncle Wallace", "Fairfield is standing in front of the debris", "with his arms crossed, vanishing in", "moments. The hole looks out into the Garden."], "Step into the garden", "Check in the debris"));
    /* 11 */ storyObjects.push(new objects.Story(["You enter the main bathroom, the bath", "tub is full and the words help me is smeared", "on the mirror in blood. As you look in", "the mirror, you see a body in the water of the tub.", "You turn around and see the ghost of young Cynthia", "Fairfield. She vanishes and leaves you in", "the silence of the house."], "Check the Tub", "Check behind mirror"));
    /* 12 */ storyObjects.push(new objects.Story(["You enter into the master bedroom. You find Uncle", "Charlie and Aunt June Fairfield embracing", "in the room.The ghost Charlie breaks June’s neck", "and fades away. Uncle Charlie Fairfield was the one", "to murder the rest of the family."], "Check under the bed", "Run back into the hallway"));
